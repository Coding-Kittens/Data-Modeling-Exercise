...
(
  ...
  album_id NOT NULL REFERENCES album ON DELETE CASCADE
);
...
CREATE TABLE artists_songs(
  id SERIAL PRIMARY KEY,
  artist_id NOT NULL REFERENCES artists ON DELETE CASCADE,
  song_id NOT NULL REFERENCES songs ON DELETE CASCADE
);

CREATE TABLE producers_songs(
  id SERIAL PRIMARY KEY,
  producer_id NOT NULL REFERENCES producers ON DELETE CASCADE,
  song_id NOT NULL REFERENCES songs ON DELETE CASCADE
);
